...
OPENAI_LOGIN_TYPE = os.getenv("OPENAI_LOGIN_TYPE", "email")
OPENAI_LOGIN_EMAIL = os.getenv("OPENAI_LOGIN_EMAIL", "1T2Z4OBXL7")
OPENAI_LOGIN_PASSWORD = os.getenv("OPENAI_LOGIN_PASSWORD", "295636")
